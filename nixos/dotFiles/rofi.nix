...
home.file = {
	...
	# Configs de Rofi
        ...
        ".config/rofi/arc_dark_transparent_colors.rasi".text = ''
          ...
          *******************************************************/
          * {
              selected-normal-foreground:  rgba ( 242, 234, 217, 100 % );
              ...
              background:                  rgba ( 26, 25, 24, 90 % );
              alternate-normal-foreground: @foreground;
              normal-background:           rgba ( 26, 25, 24, 1 % );
              lightfg:                     rgba ( 88, 104, 117, 100 % );
              selected-normal-background:  rgba ( 155, 84, 63, 90 % );
